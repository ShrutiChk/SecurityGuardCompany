...
drop table Payment_monthly_info;
...
Create table Payment_monthly_info(
	payid     integer, 
...
insert into guards values(12, 'Taimur', 'Lalmatia', 30,'Male',5.5,12000,'Dhaka',4,4.1,'Free','Office');
insert into guards values(13, 'Zara', 'Bashabo', 29,'Female',5.2,13000,'Chittagong',4,4.2,'Free','Office');
insert into guards values(14, 'Morshed', 'Shyamoli', 33,'Male',5.8,14000,'Dhaka',5,4.3,'Free','Office');
insert into guards values(15, 'Maksud', 'Mirpur', 36,'Male',5.1,12000,'Dhaka',4,4.6,'Free','University');
insert into guards values(16, 'Moshiur', 'Bashabo', 33,'Male',5.3,12000,'Chittagong',4,4.2,'Free','Shopping mall');
insert into guards values(17, 'Ekram', 'Bosila',32,'Male',5.4,11000,'Dhaka',3,3.9,'Free','School');
insert into guards values(18, 'Aklima', 'Mirpur', 30,'Female',5.3,12000,'Chittagong',3,4.5,'Free','School');
